...
var MemberService = /** @class */ (function () {
    ...
    MemberService.prototype.createMember = function (memberToCreate) {
        ...
        return this.http.post(this.baseUrl + 'create', body, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    MemberService.prototype.getAllMembers = function () {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        return this.http.get(this.baseUrl, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    MemberService.prototype.getMemberById = function (id) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        return this.http.get(this.baseUrl + id, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    MemberService.prototype.updateMemberName = function (memberToUpdate) {
        ...
        return this.http.put(this.baseUrl + 'update/name', body, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    MemberService.prototype.deleteMember = function (memberToDeleteId) {
        ...
        return this.http.delete(this.baseUrl + 'delete', { body: body, headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
