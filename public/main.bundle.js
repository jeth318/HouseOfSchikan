...
module.exports = "<div class=\"ui container\">\n    <p style=\"font-size: 1.2rem; margin: 0;\">C/O: Schikan</p>\n        <app-header></app-header>    \n    <div [ngClass]=\"showSettings==true ? 'ui two columns grid centered stackable' : 'ui one columns grid centered stackable'\">\n            <div class=\"column\">\n                    <app-member></app-member>\n                </div>\n        <div class=\"column\">\n            <app-schedule></app-schedule>\n        </div>\n    </div>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_member_member_component__ = __webpack_require__("../../../../../src/app/components/member/member.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__components_member_member_component__["a" /* MemberComponent */],
            ],
            imports: [
...
var MemberComponent = (function () {
    ...
    MemberComponent.prototype.fetchEvent = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this._memberService.getAllMembers().subscribe(function (data) {
                if (data.success) {
...
var ScheduleComponent = (function () {
    ...
    ScheduleComponent.prototype.fetchEvent = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this._memberService.getAllMembers()
