...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_member_member_component__ = __webpack_require__("../../../../../src/app/components/member/member.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_schedule_schedule_component__ = __webpack_require__("../../../../../src/app/components/schedule/schedule.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__components_member_member_component__["a" /* MemberComponent */],
                __WEBPACK_IMPORTED_MODULE_9__components_schedule_schedule_component__["a" /* ScheduleComponent */],
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__services_member_service__["a" /* MemberService */]
            ],
...
var MemberComponent = (function () {
    ...
    MemberComponent.prototype.toggleSettings = function () {
    ...
    MemberComponent.prototype.getAllMembers = function () {
        ...
        this._memberService.getAllMembers().subscribe(function (data) {
            data.success ? _this.members = data.members : null;
        });
    };
    MemberComponent.prototype.selectedMember = function (id) {
        ...
        this.members.forEach(function (memb, i) {
            if (memb._id === id) {
                _this.memberModel = _this.members[i];
                return;
            }
        });
    };
    ...
    MemberComponent.prototype.deleteMember = function () {
        ...
        if (r == true) {
            txt = "You pressed OK!";
            this._memberService.deleteMember(this.memberModel._id).subscribe(function (data) { }, function (error) { }, function () {
                _this.getAllMembers();
                _this.isLoading = false;
                _this.memberModel = {};
    ...
    MemberComponent.prototype.cancel = function () {
        this.memberModel = {};
        this.modalVisible = false;
    };
    MemberComponent.prototype.addNew = function () {
        ...
        this._memberService.createMember(this.memberModel).subscribe(function (data) { }, function (error) { }, function () {
            _this.getAllMembers();
            _this.isLoading = false;
            _this.memberModel = {};
            _this.modalVisible = false;
...
var ScheduleComponent = (function () {
    ...
    ScheduleComponent.prototype.getAllTasks = function () {
        var _this = this;
        this._taskService.getAllTasks()
            .subscribe(function (data) {
            data.success ? _this.tasks = data.tasks : null;
        });
    };
    ScheduleComponent.prototype.getAllMembers = function () {
        var _this = this;
    ...
    ScheduleComponent.prototype.getInitials = function (memberIndex) {
        return this.members[memberIndex].firstName.slice(0, 1) +
            '.' + this.members[memberIndex].lastName.slice(0, 1);
    };
    ScheduleComponent.prototype.generateTaskList = function () {
        var _this = this;
        console.log('Ricke');
        var taskReturn = [];
        var membCount = this.members.length;
        ...
        this.tasks.forEach(function (task, i) {
            if (taskReturn[i % membCount] === undefined)
                ...
                taskReturn[i % membCount].push(_this.tasks[i % taskCount]);
            else
                taskReturn[i % membCount] = [taskReturn[i % membCount], _this.tasks[i % taskCount]];
        });
        console.log(taskReturn);
        this.taskList = taskReturn;
    };
    ScheduleComponent.prototype.renderTaskList = function (memberIndex, monthIndex) {
